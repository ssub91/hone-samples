...
import bomnal.batch.example.task.ExBat010JTask;
...
public class ExBat010JTest extends AbstractBatchTest {
    ...
    public void testBatch() {
        ...
        int result = runner.runBatch("EXBAT010J", ExBat010JTask.class, null, shellParameters);
