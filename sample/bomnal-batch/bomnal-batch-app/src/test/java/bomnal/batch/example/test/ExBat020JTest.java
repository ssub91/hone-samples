...
import bomnal.batch.example.task.ExBat020JTask;
...
public class ExBat020JTest extends AbstractBatchTest {
	...
	public void testBatch() {
		...
		int result = runner. runBatch ("ExBat020J", ExBat020JTask.class, null, 
				shellParameters);
